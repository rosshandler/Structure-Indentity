...
writeMM(t(logcounts(sce)), "/data1/ivanir/Ilaria2023/ParseBS/newvolume/analysis/sCell/combined/sctour/norm_counts_hvgs.mtx", sep="\t")
writeLines(colnames(sce), "/data1/ivanir/Ilaria2023/ParseBS/newvolume/analysis/sCell/combined/sctour/cells_norm_hvgs.txt")
writeLines(rowData(sce)$gene_name, "/data1/ivanir/Ilaria2023/ParseBS/newvolume/analysis/sCell/combined/sctour/genes_norm_hvgs.txt")
